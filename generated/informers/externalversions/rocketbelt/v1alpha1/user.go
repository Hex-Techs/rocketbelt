	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.RocketbeltV1alpha1().Users().List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.RocketbeltV1alpha1().Users().Watch(context.TODO(), options)
			},
		},
		&rocketbeltv1alpha1.User{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *userInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&rocketbeltv1alpha1.User{}, f.defaultInformer)
}
